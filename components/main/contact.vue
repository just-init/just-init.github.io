                            ...
                            <form>
                                <v-row class="mt-15">
                                    ...
                                    <v-col cols="12" class="py-0">
                                        <v-textarea name="message" outlined label="Message" rows="3"></v-textarea>
                                    </v-col>
                                </v-row>
                                <v-btn nuxt to="/" class="btn-custom-md btn-danger-gradient mt-12" outlined color="white"
                                    elevation="0">
                                    Submit
                                </v-btn>
                            </form>
...
export default Vue.extend({
    data() {
        return {
            name: "대표 문의 메일",
            email: "justinit.service@gmail.com",
        }
    }
})
</script>